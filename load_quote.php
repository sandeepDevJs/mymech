...
elseif (empty($_SESSION['cart'])) {
    ...
    foreach ($services_id as $id) {
        ...
        foreach ($result as $data) {
            ...
            //cross button to remove items from cart. And calling js function.
            echo "<td><i class='fa fa-window-close color-red' onclick=delete_from_cart(" . $data['id'] . ") aria-hidden='true'></i></td>";
            //adding prices
